 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: kt, defineProperty: Dt, getOwnPropertyDescriptor: Et, getOwnPropertyNames: Pt, getOwnPropertySymbols: Tt, getPrototypeOf: Ot } = Object, x = globalThis, ot = x.trustedTypes, Lt = ot ? ot.emptyScript : "", Y = x.reactiveElementPolyfillSupport, z = (a, t) => a, B = { toAttribute(a, t) {
  switch (t) {
    case Boolean:
      a = a ? Lt : null;
      break;
...
let P = class extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const l = i.getPropertyOptions(s), n = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((r = l.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? l.converter : B;
      this._$Em = s, this[s] = n.fromAttribute(e, l.type) ?? ((o = this._$Ej) == null ? void 0 : o.get(s)) ?? null, this._$Em = null;
    }
  }
  requestUpdate(t, e, i) {
    var s;
    if (t !== void 0) {
      ...
      if (i ?? (i = r.getPropertyOptions(t)), !((i.hasChanged ?? it)(o, e) || i.useDefault && i.reflect && o === ((s = this._$Ej) == null ? void 0 : s.get(t)) && !this.hasAttribute(r._$Eu(t, i)))) return;
      this.C(t, e, i);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const U = globalThis, G = U.trustedTypes, lt = G ? G.createPolicy("lit-html", { createHTML: (a) => a }) : void 0, _t = "$lit$", b = `lit$${Math.random().toFixed(9).slice(2)}$`, xt = "?" + b, Mt = `<${xt}>`, D = document, j = () => D.createComment(""), H = (a) => a === null || typeof a != "object" && typeof a != "function", st = Array.isArray, zt = (a) => st(a) || typeof (a == null ? void 0 : a[Symbol.iterator]) == "function", J = `[ 	
...
const jt = (a, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const n = a[l];
    let d, p, c = -1, y = 0;
    for (; y < n.length && (o.lastIndex = y, p = o.exec(n), p !== null); ) y = o.lastIndex, o === M ? p[1] === "!--" ? o = ct : p[1] !== void 0 ? o = dt : p[2] !== void 0 ? ($t.test(p[2]) && (s = RegExp("</" + p[2], "g")), o = S) : p[3] !== void 0 && (o = S) : o === S ? p[0] === ">" ? (o = s ?? M, c = -1) : p[1] === void 0 ? c = -2 : (c = o.lastIndex - p[2].length, d = p[1], o = p[3] === void 0 ? S : p[3] === '"' ? pt : ht) : o === pt || o === ht ? o = S : o === ct || o === dt ? o = M : (o = S, s = void 0);
    const v = o === S && a[l + 1].startsWith("/>") ? " " : "";
    r += o === M ? n + Mt : c >= 0 ? (i.push(d), n.slice(0, c) + _t + n.slice(c) + b + v) : n + b + (c === -2 ? l : v);
  }
  return [Ct(a, r + (a[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), i];
};
class R {
    ...
    for (; (s = A.nextNode()) !== null && n.length < l; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const c of s.getAttributeNames()) if (c.endsWith(_t)) {
          const y = p[o++], v = s.getAttribute(c).split(b), q = /([.?@])?(.*)/.exec(y);
          n.push({ type: 1, index: r, name: q[2], strings: v, ctor: q[1] === "." ? Rt : q[1] === "?" ? Nt : q[1] === "@" ? It : Z }), s.removeAttribute(c);
        } else c.startsWith(b) && (n.push({ type: 6, index: r }), s.removeAttribute(c));
        if ($t.test(s.tagName)) {
          const c = s.textContent.split(b), y = c.length - 1;
          if (y > 0) {
            s.textContent = G ? G.emptyScript : "";
            for (let v = 0; v < y; v++) s.append(c[v], j()), A.nextNode(), n.push({ type: 2, index: ++r });
            s.append(c[y], j());
          }
        }
      } else if (s.nodeType === 8) if (s.data === xt) n.push({ type: 2, index: r });
      else {
        let c = -1;
        for (; (c = s.data.indexOf(b, c + 1)) !== -1; ) n.push({ type: 7, index: r }), c += b.length - 1;
      }
      r++;
    }
  }
...
function O(a, t, e = a, i) {
  ...
  return (s == null ? void 0 : s.constructor) !== r && ((l = s == null ? void 0 : s._$AO) == null || l.call(s, !1), r === void 0 ? s = void 0 : (s = new r(a), s._$AT(a, e, i)), i !== void 0 ? (e._$Co ?? (e._$Co = []))[i] = s : e._$Cl = s), s !== void 0 && (t = O(a, s._$AS(a, t.values), s, i)), t;
}
class Ht {
  constructor(t, e) {
  ...
  u(t) {
    ...
    A.currentNode = s;
    let r = A.nextNode(), o = 0, l = 0, n = i[0];
    for (; n !== void 0; ) {
      if (o === n.index) {
        let d;
        n.type === 2 ? d = new I(r, r.nextSibling, this, t) : n.type === 1 ? d = new n.ctor(r, n.name, n.strings, this, t) : n.type === 6 && (d = new Vt(r, this, t)), this._$AV.push(d), n = i[++l];
      }
      o !== (n == null ? void 0 : n.index) && (r = A.nextNode(), o++);
    }
...
class I {
  ...
  k(t) {
    ...
    const e = this._$AH;
    let i, s = 0;
    for (const r of t) s === e.length ? e.push(i = new I(this.O(j()), this.O(j()), this, this.options)) : i = e[s], i._$AI(r), s++;
...
class Z {
  ...
  _$AI(t, e = this, i, s) {
    ...
    let o = !1;
    if (r === void 0) t = O(this, t, e, 0), o = !H(t) || t !== this._$AH && t !== T, o && (this._$AH = t);
    else {
      const l = t;
      let n, d;
      for (t = r[0], n = 0; n < r.length - 1; n++) d = O(this, l[i + n], e, n), d === T && (d = this._$AH[n]), o || (o = !H(d) || d !== this._$AH[n]), d === h ? t = h : t !== h && (t += (d ?? "") + r[n + 1]), this._$AH[n] = d;
    }
    o && !s && this.j(t);
  }
  j(t) {
...
const qt = (a, t, e) => {
  ...
  if (s === void 0) {
    ...
    i._$litPart$ = s = new I(t.insertBefore(j(), r), r, void 0, e ?? {});
  }
  return s._$AI(a), s;
};
/**
...
var wt;
$._$litElement$ = !0, $.finalized = !0, (wt = k.litElementHydrateSupport) == null || wt.call(k, { LitElement: $ });
...
const Wt = { attribute: !0, type: String, converter: B, reflect: !1, hasChanged: it }, Bt = (a = Wt, t, e) => {
  ...
  if (r === void 0 && globalThis.litPropertyMetadata.set(s, r = /* @__PURE__ */ new Map()), i === "setter" && ((a = Object.create(a)).wrapped = !0), r.set(e.name, a), i === "accessor") {
    const { name: o } = e;
    return { set(l) {
      const n = t.get.call(this);
      t.set.call(this, l), this.requestUpdate(o, n, a);
    }, init(l) {
  ...
  if (i === "setter") {
    ...
    return function(l) {
      const n = this[o];
      t.call(this, l), this.requestUpdate(o, n, a);
    };
  }
  throw Error("Unsupported decorator location: " + i);
};
function C(a) {
  return (t, e) => typeof e == "object" ? Bt(a, t, e) : ((i, s, r) => {
...
var Ft = Object.defineProperty, Kt = Object.getOwnPropertyDescriptor, Yt = Object.getPrototypeOf, Jt = Reflect.get, St = (a, t, e, i) => {
  for (var s = i > 1 ? void 0 : i ? Kt(t, e) : t, r = a.length - 1, o; r >= 0; r--)
...
var ee = Object.defineProperty, ie = Object.getOwnPropertyDescriptor, se = Object.getPrototypeOf, ae = Reflect.get, V = (a, t, e, i) => {
  for (var s = i > 1 ? void 0 : i ? ie(t, e) : t, r = a.length - 1, o; r >= 0; r--)
    (o = a[r]) && (s = (i ? o(t, e, s) : o(s)) || s);
...
var ce = Object.defineProperty, de = Object.getOwnPropertyDescriptor, he = Object.getPrototypeOf, pe = Reflect.get, L = (a, t, e, i) => {
  for (var s = i > 1 ? void 0 : i ? de(t, e) : t, r = a.length - 1, o; r >= 0; r--)
    (o = a[r]) && (s = (i ? o(t, e, s) : o(s)) || s);
  ...
  render() {
    ...
    return u`
      ...
      return console.log(
        ...
        return console.log(
          `time-slots-display: Checking time ${o} for slot on ${i}:`,
          l
        ), l ? u`
                      <button
...
var fe = Object.defineProperty, me = Object.getOwnPropertyDescriptor, ye = Object.getPrototypeOf, we = Reflect.get, E = (a, t, e, i) => {
  for (var s = i > 1 ? void 0 : i ? me(t, e) : t, r = a.length - 1, o; r >= 0; r--)
    (o = a[r]) && (s = (i ? o(t, e, s) : o(s)) || s);
...
let g = class extends ve {
  ...
  transformSlotsData(a) {
    ...
    a.forEach((i) => {
      ...
      t.has(s) || t.set(s, []), (r = t.get(s)) == null || r.push(i);
    });
